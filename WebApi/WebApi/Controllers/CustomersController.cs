...
namespace WebApi.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        */
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<Login>> DeleteCustomer(int id)
        {
            var login = _context.Login.Include(x => x.CustomerID == id).SingleOrDefault(x => x.CustomerID == id);
            if (login == null || !CustomerExists(id))
            {
                return NotFound();
            }
